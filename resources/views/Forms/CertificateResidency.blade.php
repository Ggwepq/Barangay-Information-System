    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p>
                ...
                of legal age, is a resident of {{ $post->street }},
                {{ ucwords(strtolower($settings->barangay_name)) }},
                Zone {{ $settings->zone }}, District {{ $settings->district }},
                City of {{ ucwords(strtolower(str_replace('CITY', '', $settings->city))) }}, Philippines.
            </p>
            <p>
