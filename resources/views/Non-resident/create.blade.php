                    ...
                    <div class="col-md-9">
                            ...
                            <div class="row">
                                <div class="col-sm-3" style="margin-top:20px;">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" checked name="gender" id="inlineCheckbox1"
                                            value="1"> Male
                                    </label>
                                    <label class="checkbox-inline">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class='input-group date' id='datetimepicker1'>
                                        <input type='text' name="birthdate" id="bday"
                                            value="{{ old('birthdate') }}" placeholder="YYYY-MM-DD"
                                            class="form-control" />
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" name="birthPlace" maxlength="100"
                                        value="{{ old('birthPlace') }}" class="col-sm-6 form-control"
                                        id="exampleInputEmail1" placeholder="Place of Birth">
                                </div>
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="col-sm-6 form-control"
                                        value="{{ old('periodResidence') }}" maxlength="50" name="periodResidence"
                                        id="exampleInputEmail1" placeholder="Period of Residence">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="col-sm-6 form-control"
                                        value="{{ old('contactNumber') }}" maxlength="50" name="contactNumber"
                                        id="contactNumber" placeholder="Contact Number">
                                </div>
                                <div class="col-sm-4">
                                    <label>Voter's Id No.<span style="color:red;"></span></label>
                                    <input type="text" class="col-sm-6 form-control" value="{{ old('voterId') }}"
                                        maxlength="50" name="voterId" id="voterId" placeholder="Voter's Id No.">
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="col-sm-6 form-control" value="{{ old('precintNo') }}"
                                        maxlength="50" name="precintNo" id="precint"
                        ...
                        <div style="margin-top:10px; margin-bottom:10px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="col-sm-6 form-control"
                                        value="{{ old('motherFirstName') }}" maxlength="70" name="motherFirstName"
                                        id="exampleInputEmail1" placeholder="First Name">
                                </div>
                                <div class="col-sm-3">
                                    <label>Middle Name<span style="color:red;"></span></label>
                                    <input type="text" class="col-sm-6 form-control"
                                        value="{{ old('motherMiddleName') }}" maxlength="20" name="motherMiddleName"
                                        id="exampleInputEmail1" placeholder="Middle Name">
                                </div>
                                <div class="col-sm-3">
                                    <label>Last Name<span style="color:red;">*</span></label>
                                    <input type="text" class="col-sm-6 form-control"
                                        value="{{ old('motherLastName') }}" maxlength="50" name="motherLastName"
                        ...
                        <div style="margin-top:10px; margin-bottom:10px;">
                            <div class="row">
                                <div class="col-sm-6">
                                    <label>First Name<span style="color:red;">*</span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="70"
                                        value="{{ old('fatherfirstName') }}" name="fatherFirstName"
                                        id="exampleInputEmail1" placeholder="First Name">
                                </div>
                                <div class="col-sm-3">
                                    <label>Middle Name<span style="color:red;"></span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="20"
                                        value="{{ old('fatherMiddleName') }}" name="fatherMiddleName"
                                        id="exampleInputEmail1" placeholder="Middle Name">
                                </div>
                                <div class="col-sm-3">
                                    <label>Last Name<span style="color:red;">*</span></label>
                                    <input type="text" class="col-sm-6 form-control" maxlength="50"
                                        value="{{ old('fatherLastName') }}" name="fatherLastName"
                                        id="exampleInputEmail1" placeholder="Last Name">
                                </div>
                            </div>
                        </div>
